---
title: "[DSA] 紅黑樹 (Red-Black Tree) 介紹 - Part 2: Removal "
date: 2022-09-28
tags: [Tree]
...
![](/my-blog/images/dsa/tree/binary_tree/binary_search_tree/red_black_tree/rb_tree_remove_internal_node.png)
...
![](/my-blog/images/dsa/tree/binary_tree/binary_search_tree/red_black_tree/rb_tree_remove.png)
...
![](/my-blog/images/dsa/tree/binary_tree/binary_search_tree/red_black_tree/rb_tree_remove_black_sibling_transfer.png)
...
![](/my-blog/images/dsa/tree/binary_tree/binary_search_tree/red_black_tree/rb_tree_remove_black_sibling_fuse.png)
...
此 Red sibling 為假兄弟，需 `Rotate 3-node` 後，再進行相關處理，看他是 [Case 2-1: 有人可以借](#case-2-1-black-sibling-and-has-red-child) 或是 [Case 2-2: 無人可借](#case-2-2-black-sibling-and-has-black-child) 的情形，如下所示:

![](images/rb_tree_remove_red_sibling.png)
![](/my-blog/images/dsa/tree/binary_tree/binary_search_tree/red_black_tree/rb_tree_remove_red_sibling.png)
...
![](/my-blog/images/dsa/tree/binary_tree/binary_search_tree/red_black_tree/rb_tree_remove_red_sibling_transfer.png)

對照 2-3-4 Tree

![](images/2-3-4_tree_remove_transfer.png)
![](/my-blog/images/dsa/tree/binary_tree/binary_search_tree/red_black_tree/2-3-4_tree_remove_transfer.png)
